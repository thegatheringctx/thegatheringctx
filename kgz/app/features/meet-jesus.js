...
(function(){
 ...
 var SCENES=[
  {e:'❤️',h:'God Loves You',
   ...
   v:'See what kind of love the Father has given to us, that we should be called children of God.',vr:'1 John 3:1'},
  ...
  {e:'✝️',h:'Jesus Is the Rescue',
   ...
   v:'God shows his love for us in that while we were still sinners, Christ died for us.',vr:'Romans 5:8'},
  {e:'🎁',h:'It’s a Gift',
   ...
   v:'By grace you have been saved through faith. And this is not your own doing; it is the gift of God.',vr:'Ephesians 2:8'},
  {e:'🙋',h:'How to Respond',
   ...
   v:'If you confess with your mouth that Jesus is Lord and believe in your heart that God raised him from the dead, you will be saved.',vr:'Romans 10:9'}
 ];
 ...
 function launch(){
  ...
  function questions(){
   card.innerHTML="<div class='gv-emoji'>❓</div><h3 class='gv-h'>Questions Are Good</h3>"+
     ...
     "<p class='gv-p'>The best thing to do is ask a grown-up who loves Jesus, like your parents or your pastor. They would <b>love</b> to sit down and talk with you about anything you’re wondering.</p>";
   g.speak('Questions are good! God is not scared of your questions. Ask a grown-up who loves Jesus, like your parents or your pastor.');
   endBar();
  }
  function thinking(){
