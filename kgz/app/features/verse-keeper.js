...
(function(){
 ...
 // my/mo = meaning for 4–7 / 8–12. Verse text is ESV.
 var V=[
  ...
  {id:'php413', ref:'Philippians 4:13',
   ...
   my:'Whether my day is easy or hard, Jesus gives me what I need to keep going.',
   mo:'Paul wrote this from a prison cell. He had learned to be content with a lot or with a little, because Christ gave him strength in every situation. It is not a promise that I will get what I want. It is a promise that He is enough either way.'},
 ...
 function launch(){
  ...
  function finish(){
   ...
   card.innerHTML="<div class='gv-emoji'>⭐</div><h3 class='gv-h'>Verses Kept Strong</h3>"+
     "<p class='gv-p'>You’re keeping <b style='color:#f5c842'>"+strong+"</b> of <b>"+V.length+"</b> verses strong. Come back tomorrow, and the ones fading will pop up first so you never lose them.</p>"+
